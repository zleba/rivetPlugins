...
source /cvmfs/sft.cern.ch/lcg/releases/LCG_93a/Python/2.7.13/x86_64-slc6-gcc62-opt/Python-env.sh

source /cvmfs/sft.cern.ch/lcg/releases/LCG_88/ROOT/6.08.06/x86_64-slc6-gcc62-opt/bin/thisroot.sh


#. /cvmfs/sft.cern.ch/lcg/releases/LCG_88/MCGenerators/rivet/2.5.3/x86_64-slc6-gcc62-opt/rivetenv.sh
source /cvmfs/sft.cern.ch/lcg/releases/LCG_93a/MCGenerators/rivet/2.6.0/x86_64-slc6-gcc62-opt/rivetenv.sh
